// Reproducible CC0 avatar catalog; dependencies live in assets/roku/package.json.
import { readFile, mkdir, writeFile } from 'node:fs/promises';
import { Avatar, Style } from '../../node_modules/@dicebear/core/lib/index.js';
...
for (const [id,name] of categories) {
 const definition=JSON.parse(await readFile(new URL(`../../node_modules/@dicebear/styles/dist/${id}.min.json`,import.meta.url)));
