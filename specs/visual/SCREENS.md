...
All coordinates are logical pixels in the canonical frame. Screen headings use the shared x=100 header unless stated otherwise. The runtime layout, including dynamic overrides, is evidenced by [PresentationScene](https://github.com/vynxc/viptv/blob/7d6b4131a44d87b58edcf12709af5851da387176/roku/components/PresentationScene.brs), [MainScene structure](https://github.com/vynxc/viptv/blob/7d6b4131a44d87b58edcf12709af5851da387176/roku/components/MainScene.xml), [HeroPanel](https://github.com/vynxc/viptv/blob/7d6b4131a44d87b58edcf12709af5851da387176/roku/components/HeroPanel.brs), and [account gateway](https://github.com/vynxc/viptv/blob/7d6b4131a44d87b58edcf12709af5851da387176/roku/components/AccountScene.brs). These links support auditing; this document is the reconstruction contract.
...
The first shelf is pinned to the hero. In first-row focus, full hero remains visible. Moving to any lower shelf uses the compact hero and expands the shelf viewport: shelves move to x=92 y=100 and clip at 1188×620. This preserves the hero item's focus/metadata relationship while making lower rows readable. Home actions sit x=100 y=375 as two 144×50 items separated by 12px; a `Play next episode` action widens to 236px. The retry button is x=1030 y=64, 160–184px wide.
