...
Measure actual automated results against each group. A passing simulation is not a claim of 100% physical Tizen/Vizio/Android TV compatibility. Report untested hardware codec/DRM/signing/store constraints with the artifact. Try available emulators; lack of hardware does not prevent frontend visual and remote testing. Screenshots may be created under ignored test-results/artifacts for inspection, never in design or packaged application artifacts.
