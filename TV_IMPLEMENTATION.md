...
Measure actual automated results against each group. A passing simulation is not a claim of 100% physical Tizen/Vizio/Android TV compatibility. Report untested hardware codec/DRM/signing/store constraints with the artifact. The owner subsequently deferred emulators and runtime testing after server OOM; follow TV_CANDIDATE_2026_09_12.md for current resource constraints. Screenshots may be created under ignored test-results/artifacts for inspection, never in design or packaged application artifacts.
